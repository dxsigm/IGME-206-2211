            ...
            while (!bGameOver)
            {
                ...
                move:
                    while (nRoll > 0 && thisPlayer.currentSpace != null)
                    {
                        ...
                        if( sDirection == "+")
                        {
                            if(thisPlayer.currentSpace.Next != null)
                            {
                                thisPlayer.currentSpace = thisPlayer.currentSpace.Next;
                            }
                            else
                            {
                                break;
                        ...
                        {
                            if (thisPlayer.currentSpace.Previous != null)
                            {
                                thisPlayer.currentSpace = thisPlayer.currentSpace.Previous;
                            }
                            else
                            {
                                break;
                    ...
                    if(thisPlayer.currentSpace.Value.hasPenalty)
                    {
                        thisPlayer.currentSpace.Value.hasPenalty = false;
                    ...
                    if (thisPlayer.currentSpace.Value.hasPowerUp)
                    {
                        thisPlayer.currentSpace.Value.hasPowerUp = false;
                    ...
                    ///      goto move;
                    ///  }
                    if (thisPlayer.currentSpace.Value.shortcut != null)
                    {
                        thisPlayer.currentSpace = thisPlayer.currentSpace.Value.shortcut;
                ...
                if( player1.currentSpace == board.Last)
                {
