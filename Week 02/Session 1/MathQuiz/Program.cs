...
class Program
{
    ...
    static void Main()
    {
        ...
        while (true)
        {
            ...
            // ensure they typed something
            // to compare if strings are less than or greater than, we need to use the CompareTo() method
            //if (myName.CompareTo("") > 0)
            
            // or we can check that the Length is greater than 0
            if (myName.Length > 0)
            {
                break;
            }
