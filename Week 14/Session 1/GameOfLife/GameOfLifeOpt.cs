...
/****************************************************
OOP: Time for 10,000 generations: 1685ms
5934 generations per second

Adjacency List with converting between int and bool[]
Time for 10,000 generations: 3304ms
3026 generations per second

Brute force rectangular array[,]
Time for 10,000 generations: 1
9057 generations per second

Jagged array implementation
Time for 10,000 generations: 551ms
 18148 generations per second
****************************************************/
...
namespace GameOfLife
{
    ...
    static public class Game
    {
        ...
        static void Main(string[] args)
        {
            ...
            //for (i = 0; i < 2; ++i)
           // {
            //    nextGens[i] = new bool[MAX_ROWS, MAX_COLS];
            //}
